  ...
  try {
    ...
    const postResult = await dbQuery(
      `INSERT INTO course_posts (
        ...
        file_size,
        mime_type
      ) VALUES ($1, $2, 'telegram', $3, $4, $5, $6, $7, $8, $9, $10, $11)
      RETURNING id`,
      [
        courseId,
        textContent,
        ...
        mediaData.media_type !== 'text' ? mediaData.media_type : null,
        localPath || null,
    ...
    await dbQuery(
      ...
      [
        ...
        JSON.stringify({
          ...
          thumbnail_file_id: mediaData.thumbnail_file_id || null,
        }),
...
async function processMediaGroup(
  ...
  try {
    const bufferResult = await dbQuery(
      `SELECT id, course_id, telegram_message_id, media_data, caption
